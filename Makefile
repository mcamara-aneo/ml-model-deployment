NAME=mc-titanic-classification-model
...
push-ml-api-aws:
	docker push ${AWS_ACCOUNT_ID}.dkr.ecr.eu-west-3.amazonaws.com/$(NAME):$(COMMIT_ID)

tag-ml-api:
	docker tag $(NAME):$(COMMIT_ID) ${AWS_ACCOUNT_ID}.dkr.ecr.eu-west-3.amazonaws.com/$(NAME):$(COMMIT_ID)
